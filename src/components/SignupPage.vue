<template>
  <div class="screen">
        <nav>
            <div class="title"> Museum'IT</div>
          <div class="header-left">
            <a href="" class="button-left">Home</a>
            <a href="" class="button-left">Stories</a>
            <a href="" class="button-left">Collections</a>  
            <a href="./SignupPage.vue" class="button-left active">SignUp</a>
            <a href="" class="button-left">Login</a>
...
.button-left.active {
  background-color: rgb(76, 36, 233);
}
.search-icon{
  align-items: center;
  margin-top: 10px;
